...
### Variables de robots
r_ll = 0.032/2                                    # Llanta del robot 67 mm para RAM01 y 02 65mm el resto
L = 0.085                                        # Distancia entre llantas 150 mm
...
try:
    while True:
        ...
        if (tact >= 4) and cambio == 0:
            cad = "@W" + str(round(vd,2)) + "D" + str(round(vd,2)) + "I#"
            RAM01.write(cad.encode('ascii'))
            cambio = 1
        
        if (tact >= 5) and cambio == 1:
            cad = "@W" + str(round(vd,2)) + "D" + str(round(vi,2)) + "I#"
            RAM01.write(cad.encode('ascii'))
            cambio = 2
