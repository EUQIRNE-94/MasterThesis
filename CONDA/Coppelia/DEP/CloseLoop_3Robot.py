...
eCode, RAM03_LM = sim.simxGetObjectHandle(clientID, 'lumibot_leftMotor#1', sim.simx_opmode_oneshot_wait)
eCode, RAM03_RM = sim.simxGetObjectHandle(clientID, 'lumibot_rightMotor#1', sim.simx_opmode_oneshot_wait)
eCode, RAM03 = sim.simxGetObjectHandle(clientID, 'lumibot_Frame#1', sim.simx_opmode_oneshot_wait)

eCode, RAM04_LM = sim.simxGetObjectHandle(clientID, 'lumibot_leftMotor#2', sim.simx_opmode_oneshot_wait)
eCode, RAM04_RM = sim.simxGetObjectHandle(clientID, 'lumibot_rightMotor#2', sim.simx_opmode_oneshot_wait)
eCode, RAM04 = sim.simxGetObjectHandle(clientID, 'lumibot_Frame#2', sim.simx_opmode_oneshot_wait)
...
eCode, pos_par03 = sim.simxGetObjectPosition(clientID, RAM03, -1, sim.simx_opmode_streaming)
eCode, ori_par03 = sim.simxGetObjectOrientation(clientID, RAM03, -1, sim.simx_opmode_streaming)
...
eCode, pos_par03 = sim.simxGetObjectPosition(clientID, RAM03, -1, sim.simx_opmode_buffer)
eCode, ori_par03 = sim.simxGetObjectOrientation(clientID, RAM03, -1, sim.simx_opmode_buffer)

X0 = np.array([pos_par01[0],pos_par02[0],pos_par03[0]])
Y0 = np.array([pos_par01[1],pos_par02[1],pos_par03[1]])
Xi0 = np.array([ori_par01[2],ori_par02[2],ori_par03[2]])
...
while tact <= tf:
    ...
    if tact - tant >= dt:
        ...
        ### Uniciclo ###
        eCode, pos_par01 = sim.simxGetObjectPosition(clientID, RAM01, -1, sim.simx_opmode_oneshot)
        eCode, ori_par01 = sim.simxGetObjectOrientation(clientID, RAM01, -1, sim.simx_opmode_oneshot)
        eCode, pos_par02 = sim.simxGetObjectPosition(clientID, RAM02, -1, sim.simx_opmode_oneshot)
        eCode, ori_par02 = sim.simxGetObjectOrientation(clientID, RAM02, -1, sim.simx_opmode_oneshot)
        eCode, pos_par03 = sim.simxGetObjectPosition(clientID, RAM03, -1, sim.simx_opmode_oneshot)
        eCode, ori_par03 = sim.simxGetObjectOrientation(clientID, RAM03, -1, sim.simx_opmode_oneshot)
        
        x_par = np.array([pos_par01[0],pos_par02[0],pos_par03[0]])
        y_par = np.array([pos_par01[1],pos_par02[1],pos_par03[1]])
        xi_par = np.array([ori_par01[2],ori_par02[2],ori_par03[2]])
        ...
        if estado == 0:
            sim.simxSetJointTargetVelocity(clientID, RAM01_RM, np.round(vd[0],2), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM01_LM, np.round(vi[0],2), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM02_RM, np.round(vd[1],2), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM02_LM, np.round(vi[1],2), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM03_RM, np.round(vd[2],2), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM03_LM, np.round(vi[2],2), sim.simx_opmode_streaming)
            estado = 1
        if estado == 1:
            sim.simxSetJointTargetVelocity(clientID, RAM01_RM, np.round(vd[0],2), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM01_LM, np.round(vi[0],2), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM02_RM, np.round(vd[1],2), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM02_LM, np.round(vi[1],2), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM03_RM, np.round(vd[2],2), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM03_LM, np.round(vi[2],2), sim.simx_opmode_oneshot)
...
sim.simxSetJointTargetVelocity(clientID, RAM03_LM, 0, sim.simx_opmode_oneshot)
sim.simxSetJointTargetVelocity(clientID, RAM03_RM, 0, sim.simx_opmode_oneshot)
