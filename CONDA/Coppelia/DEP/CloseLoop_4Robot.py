...
eCode, pos_par04 = sim.simxGetObjectPosition(clientID, RAM04, -1, sim.simx_opmode_streaming)
eCode, ori_par04 = sim.simxGetObjectOrientation(clientID, RAM04, -1, sim.simx_opmode_streaming)
...
eCode, pos_par04 = sim.simxGetObjectPosition(clientID, RAM04, -1, sim.simx_opmode_buffer)
eCode, ori_par04 = sim.simxGetObjectOrientation(clientID, RAM04, -1, sim.simx_opmode_buffer)

X0 = np.array([pos_par01[0],pos_par02[0],pos_par03[0],pos_par04[0]])
Y0 = np.array([pos_par01[1],pos_par02[1],pos_par03[1],pos_par04[1]])
Xi0 = np.array([ori_par01[2],ori_par02[2],ori_par03[2],ori_par04[2]])
...
while tact <= tf:
    ...
    if tact - tant >= dt:
        ...
        x_par = np.array([pos_par01[0],pos_par02[0],pos_par03[0],pos_par04[0]])
        y_par = np.array([pos_par01[1],pos_par02[1],pos_par03[1],pos_par04[1]])
        xi_par = np.array([ori_par01[2],ori_par02[2],ori_par03[2],ori_par04[2]])
        ...
        if estado == 0:
            ...
            sim.simxSetJointTargetVelocity(clientID, RAM03_RM, np.round(vd[2],4), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM03_LM, np.round(vi[2],4), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM04_RM, np.round(vd[3],4), sim.simx_opmode_streaming)
            sim.simxSetJointTargetVelocity(clientID, RAM04_LM, np.round(vi[3],4), sim.simx_opmode_streaming)
            estado = 1
        if estado == 1:
            ...
            sim.simxSetJointTargetVelocity(clientID, RAM03_RM, np.round(vd[2],4), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM03_LM, np.round(vi[2],4), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM04_RM, np.round(vd[3],4), sim.simx_opmode_oneshot)
            sim.simxSetJointTargetVelocity(clientID, RAM04_LM, np.round(vi[3],4), sim.simx_opmode_oneshot)
...
sim.simxSetJointTargetVelocity(clientID, RAM04_LM, 0, sim.simx_opmode_oneshot)
sim.simxSetJointTargetVelocity(clientID, RAM04_RM, 0, sim.simx_opmode_oneshot)
