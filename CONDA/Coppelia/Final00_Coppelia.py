...
Ks = np.array([[0.4,0.1,0.4,1,0.1,1]])  # [Cx,Cxk,Cxi,Cy,Cyk,K] Ganancias de control del uniciclo
...
if perturbacion == True:
    np.savez('DATA/00_dataPert',robots=N,tiempo=tspan,Xref=Xr,Yref=Yr,Xiref=Xir,xest=x,yest=y,xiest=xi,errx=err_x,erry=err_y,errxi=err_xi,vellin=v,velang=w,veleva=v_eva)
else:
    np.savez('DATA/00_data',robots=N,tiempo=tspan,Xref=Xr,Yref=Yr,Xiref=Xir,xest=x,yest=y,xiest=xi,errx=err_x,erry=err_y,errxi=err_xi,vellin=v,velang=w,veleva=v_eva)