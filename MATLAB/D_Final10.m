...
legend({'e1','e2','e3','e4','e5','e6'},'Orientation','horizontal','location','southwest','fontsize',14)
...
legend({'rep_1','rep_2','rep_3','rep_4','rep_5','rep_6'},'Orientation','Vertical' ...
...
legend({'\omega_1','\omega_2','\omega_3','\omega_4','\omega_5','\omega_6'}, ...
  'Orientation','Horizontal','location','southwest','fontsize',14)
