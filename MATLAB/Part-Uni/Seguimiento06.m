...
for k = 1:n-1
  ...
  if k == n-1
    ...
    [Xr(k+1,:),Yr(k+1,:),thetar(k+1,:)] = linea(w0,theta(k+1,:),R0,1,kf,i);
...
xlabel('e_1','fontsize',20)
ylabel('e_2','fontsize',20)
...
for j = 1:N
  ...
  text(Xr(n,j),Yr(n,j),num2str(j),'fontsize',22)
end
